        ...
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm font-semibold text-slate-500 dark:text-slate-400">
                    Actualiza los datos generales de la capacitación.
                </p>
            </div>
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-[2rem] border border-slate-200/90 bg-white/90 shadow-xl shadow-slate-200/60 backdrop-blur dark:border-slate-700 dark:bg-slate-900/80 dark:shadow-none">
                <div class="border-b border-slate-100 px-6 py-6 dark:border-slate-800">
                    ...
                    <p class="mt-1 text-sm font-semibold text-slate-500 dark:text-slate-400">
                        Modifica la información principal sin afectar la estructura ya creada.
                    </p>
                </div>

                <form method="POST"
                      action="{{ route('capacitaciones.update', $capacitacion->id_capacitacion) }}"
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text"
                                   name="capacitacion"
                                   value="{{ old('capacitacion', $capacitacion->capacitacion) }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="codigo"
                                   value="{{ old('codigo', $capacitacion->codigo) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="descripcion"
                                      rows="4"
                                      class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-sm transition focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $capacitacion->descripcion) }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="rounded-3xl border border-dashed border-blue-200 bg-blue-50/50 p-4 dark:border-blue-900/60 dark:bg-blue-950/20">
                                @if($capacitacion->ruta_portada)
                                    <div class="mb-4 overflow-hidden rounded-3xl border border-slate-200 bg-white p-3 shadow-sm dark:border-slate-700 dark:bg-slate-950">
                                        <img src="{{ asset('storage/' . $capacitacion->ruta_portada) }}"
                                             alt="Portada actual"
                                             class="h-44 w-full object-cover rounded-2xl">

                                        <p class="mt-2 text-xs font-semibold text-slate-500">
                                            Portada actual. Si seleccionas otra imagen, será reemplazada.
                                        </p>
                                    </div>
                                @endif
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('horas_estimadas', $capacitacion->horas_estimadas) }}"
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('porcentaje_aprobacion', $capacitacion->porcentaje_aprobacion) }}"
                        ...
                        <div>
                            ...
                            <input type="number"
                                   name="dias_vigencia"
                                   value="{{ old('dias_vigencia', $capacitacion->dias_vigencia) }}"
                        ...
                        <div>
                            ...
                            <select name="obligatoria"
                                ...
                                <option value="1" {{ old('obligatoria', $capacitacion->obligatoria) == '1' ? 'selected' : '' }}>Sí</option>
                                <option value="0" {{ old('obligatoria', $capacitacion->obligatoria) == '0' ? 'selected' : '' }}>No</option>
                            </select>
