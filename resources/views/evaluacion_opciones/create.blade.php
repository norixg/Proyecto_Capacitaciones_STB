                    ...
                    <form method="POST" action="{{ route('evaluacion_preguntas.opciones.store', $pregunta->id_evaluacion_pregunta) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="opcion" rows="3"
                                class="w-full border rounded px-3 py-2 text-black @error('opcion') border-red-500 @enderror">{{ old('opcion') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <select name="es_correcta"
                                    ...
                                    <option value="0" {{ old('es_correcta', '0') == '0' ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ old('es_correcta') == '1' ? 'selected' : '' }}>Sí</option>
                                </select>
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="{{ route('evaluacion_preguntas.opciones.index', $pregunta->id_evaluacion_pregunta) }}" class="px-4 py-2 bg-gray-600 text-white rounded">
                                Cancelar
                            </a>
                        </div>
                    </form>
